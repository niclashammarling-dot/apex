...
| 6 | Test DB isolation | 2026-03-25 | test accidentally opened production DB | tests/conftest.py,tests/ | 2026-04-06 | — |
...
| 8 | General code health | 2026-03-25 | bare except swallowed errors silently | backend/ | 2026-03-25 | 2026-04-06 |
...
| 10 | Ticker signal data coverage | 2026-03-29 | all tickers classified weak due to insufficient days in window; no error raised | backend/db.py,backend/sector_regime.py | 2026-04-06 | — |
| 11 | NaN/null config pipeline | 2026-04-02 | parseFloat("") = NaN serialized to null; Python .get(key,default) returned None not default; delta<=None threw TypeError | frontend/src/App.jsx,backend/gate/lock_macro.py | 2026-04-06 | — |
