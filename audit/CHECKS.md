...
|---|------|-------|-------------|---------------|----------------|------------|
| 1 | Result-dict sync hazard | 2026-03-25 | gate_decision stored from early snapshot; stale field persisted to DB | backend/gate/gate_runner.py,backend/gate/gate_runner_live.py,backend/db.py | 2026-03-25 | 2026-04-03 |
| 2 | Exception-catch coverage in tests | 2026-03-25 | mock tests asserted return value but not DB write args; bug hid in persistence path | tests/ | 2026-03-25 | 2026-04-03 |
| 3 | Fractional qty in broker | 2026-03-25 | Alpaca rejected bracket orders with fractional shares (error 42210000) | backend/brokers/alpaca.py | 2026-04-03 | — |
| 4 | Config parity | 2026-03-25 | new keys added to config.py but not to demo_config/live_config | backend/config.py,data/demo_config.json,data/live_config.json | 2026-03-25 | 2026-04-03 |
| 5 | Sector name strings | 2026-03-28 | hardcoded sector name typo caused silent sector mismatch | backend/,frontend/src/ | 2026-03-28 | 2026-04-03 |
| 6 | Test DB isolation | 2026-03-25 | test accidentally opened production DB | tests/conftest.py,tests/ | 2026-04-03 | — |
| 7 | Demo/live gate runner parity | 2026-03-25 | logic fix applied to demo runner but not live runner | backend/gate/gate_runner.py,backend/gate/gate_runner_live.py | 2026-03-25 | 2026-04-03 |
| 8 | General code health | 2026-03-25 | bare except swallowed errors silently | backend/ | 2026-03-25 | 2026-04-03 |
