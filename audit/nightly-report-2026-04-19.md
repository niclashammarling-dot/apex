...
| 8c Inconsistent return types | ⚠ | WARNING | gate_runner.py:20 | Function `_gate_result` returns `dict` but has paths that could return `None` without caller guards. |
