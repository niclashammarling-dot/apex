...
| check_2_exception_catch_coverage_in_tests | ⚠ | WARNING | test_wallet.py:line | Test using side_effect=Exception does not assert DB insert mock call args. |
| check_2_exception_catch_coverage_in_tests | ⚠ | WARNING | test_gate_runners.py:line | Test using side_effect=Exception does not assert DB insert mock call args. |
