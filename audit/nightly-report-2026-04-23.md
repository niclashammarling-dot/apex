...
| check_2_exception_catch_coverage_in_tests | ⚠ | WARNING | test_wallet.py:100 | Test does not assert DB insert mock call arguments when using side_effect=Exception. |
| check_2_exception_catch_coverage_in_tests | ⚠ | WARNING | test_gate_runners.py:150 | Test does not assert DB insert mock call arguments when using side_effect=Exception. |
