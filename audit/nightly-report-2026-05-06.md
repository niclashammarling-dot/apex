# APEX Nightly Audit — 2026-05-06
12 issues: 0 critical, 8 warnings, 4 info
...
| 2 Exception-catch coverage in tests | ⚠ | WARNING | test_gate_locks.py: | Some tests using side_effect=Exception only check the return value and skip the persistence call args. |
...
| 8 General code health | ⚠ | INFO | gate_runner_live.py:74 | Bare except block missing logging in non-risk path. |
| 8 General code health | ⚠ | INFO | gate_runner_live.py:75 | TODO/FIXME/HACK comment found. |
| 8 General code health | ✓ | — | — | — |
