...
| 33 Bayesian multiplier health | ⚠ | WARNING | data/bayesian_multiplier_stats.json | Stats file is from 2026-06-08, last trading day was 2026-06-11 — gate runner did not complete a full cycle or _persist_multiplier_stats() was removed |
...
| 8 General code health | ⚠ | WARNING | gate_runner_live.py:91 | Bare except block missing logging in risk-enforcement path. |
| 8 General code health | ⚠ | INFO | gate_runner_live.py:91 | TODO/FIXME/HACK comment found. |
