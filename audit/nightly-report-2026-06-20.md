...
| 22 Yahoo data pipeline health | ⚠ | WARNING | data/regime_result_cache.json | regime_result_cache.json is 12 days old (last: 2026-06-08) — EOD regime may not have run successfully this week |
...
| 8 General code health | ⚠ | WARNING | gate_runner_live.py:75 | Bare except block missing logging in risk-enforcement path. |
| 8 General code health | ⚠ | INFO | gate_runner.py:92 | TODO/FIXME/HACK comment found. |
