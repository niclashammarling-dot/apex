...
| 22 Yahoo data pipeline health | ⚠ | WARNING | data/regime_result_cache.json | regime_result_cache.json is 14 days old (last: 2026-06-08) — EOD regime may not have run successfully this week |
| 33 Bayesian multiplier health | ⚠ | WARNING | data/bayesian_multiplier_stats.json | Stats file is from 2026-06-08, last trading day was 2026-06-19 — gate runner did not complete a full cycle or _persist_multiplier_stats() was removed |
...
| 2 Exception-catch coverage in tests | ⚠ | WARNING | test_wallet.py: line not specified | Test cases using side_effect=Exception do not assert DB insert mock call arguments. |
...
| 7 Demo/live gate runner parity | ⚠ | WARNING | gate_runner.py:150 | `_log_summary` function in demo logs "Gate" while in live it logs "Live gate", a minor inconsistency in log messages. |
